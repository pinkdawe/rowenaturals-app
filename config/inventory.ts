...
export const inventory: InventoryProduct[] = [
  {
    ...
    name: "100% Grass-Fed Tallow Bar Soap",
    description: `Ingredients: 100% Grass-Fed Beef Tallow, Water, Lye.`,
    price: 699, // price in smallest currency unit (e.g. cent for USD)
    image:
      "https://rowenaturals.shop/cdn/shop/files/2FB06117-DCD0-4036-8488-00493CD627E9.jpg?v=1706035692&width=2200",
    images: [
  ...
  },
  {
    ...
    name: "100% Grass-Fed Whipped Tallow (4oz)",
    description: `Made with 100% Grass-fed Organically raised Beef tallow, Certified Organic Golden Jojoba Oil.`,
    price: 2599,
    image:
      "https://rowenaturals.shop/cdn/shop/files/A1A14797-0805-4B4D-92DF-AF23517C5490.jpg?v=1706142373&width=2200",
    images: [
  ...
  },
  {
    ...
    name: "100% Organic Cotton Ankle Socks (3 Pack)",
    description: `Made with 100% organic US cotton`,
    price: 1799,
    image:
      "https://rowenaturals.shop/cdn/shop/files/IMG-6639.heic?v=1706822614&width=2200",
    images: [
